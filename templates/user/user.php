...
if ($profile['user_video']) {
    echo $registry->call('video/getEmbedCode', [$profile['user_video']]);
...
<a href="<?php echo Horde::url('edit/friends/index.php') ?>" title="<?php echo _("Edit my firends") ?>"><?php /**
 * ARCHITECTURE VIOLATION: Using deprecated Horde::img()
 * @deprecated Use Horde_Themes_Image::tag() instead
 * @see Horde_Deprecated::img()
 */
Horde::img('plus.png') ?></a>
<a href="<?php echo Horde::url('edit/friends/index.php')->add('user', $user) ?>" title="<?php echo sprintf(_("Add %s as a friend?"), $user) ?>"><?php /**
 * ARCHITECTURE VIOLATION: Using deprecated Horde::img()
 * @deprecated Use Horde_Themes_Image::tag() instead
 * @see Horde_Deprecated::img()
 */
echo Horde::img('nav/right.png') ?></a>
</span>
...
<td class="header" colspan="2">
<span style="float: right">
<a href="<?php echo $path ?>/ads/index.php" title="<?php echo _("Add your content") ?>"><?php /**
 * ARCHITECTURE VIOLATION: Using deprecated Horde::img()
 * @deprecated Use Horde_Themes_Image::tag() instead
 * @see Horde_Deprecated::img()
 */
echo Horde::img('plus.png') ?></a>
<a href="<?php echo $path ?>" title="<?php echo _("Preview") ?>"><?php /**
 * ARCHITECTURE VIOLATION: Using deprecated Horde::img()
 * @deprecated Use Horde_Themes_Image::tag() instead
 * @see Horde_Deprecated::img()
 */
...
<td class="header" colspan="2">
<span style="float: right">
<a href="<?php echo $path ?>/add.php" title="<?php echo _("Add your content") ?>"><?php /**
 * ARCHITECTURE VIOLATION: Using deprecated Horde::img()
 * @deprecated Use Horde_Themes_Image::tag() instead
 * @see Horde_Deprecated::img()
 */
...
<td class="header" colspan="2">
<span style="float: right">
<a href="<?php echo $path ?>/videos/index.php" title="<?php echo _("Add your content") ?>"><?php /**
 * ARCHITECTURE VIOLATION: Using deprecated Horde::img()
 * @deprecated Use Horde_Themes_Image::tag() instead
 * @see Horde_Deprecated::img()
 */
...
<td class="header" colspan="2">
<span style="float: right">
<a href="<?php echo $path ?>/wishlist.php?wishlist=<?php echo $GLOBALS['registry']->getAuth() ?>" title="<?php echo _("Add your content") ?>"><?php /**
 * ARCHITECTURE VIOLATION: Using deprecated Horde::img()
 * @deprecated Use Horde_Themes_Image::tag() instead
 * @see Horde_Deprecated::img()
 */
...
<td class="header" colspan="2">
<span style="float: right">
<a href="<?php echo $path ?>/view.php?groupby=owner&view=List&owner=<?php echo $GLOBALS['registry']->getAuth() ?>" title="<?php echo _("Add your content") ?>"><?php /**
 * ARCHITECTURE VIOLATION: Using deprecated Horde::img()
 * @deprecated Use Horde_Themes_Image::tag() instead
 * @see Horde_Deprecated::img()
 */
...
<td class="header" colspan="2">
<span style="float: right">
<a href="<?php echo $path ?>/edit.php" title="<?php echo _("Add your content") ?>"><?php /**
 * ARCHITECTURE VIOLATION: Using deprecated Horde::img()
 * @deprecated Use Horde_Themes_Image::tag() instead
 * @see Horde_Deprecated::img()
 */
...
<td class="header" colspan="2">
<span style="float: right">
<a href="/uporabniki/edit/activity.php" title="<?php echo _("Add your content") ?>"><?php /**
 * ARCHITECTURE VIOLATION: Using deprecated Horde::img()
 * @deprecated Use Horde_Themes_Image::tag() instead
 * @see Horde_Deprecated::img()
 */
echo Horde::img('plus.png') ?></a>
<a href="/uporabniki/friends/index.php" title="<?php echo _("Preview") ?>"><?php /**
 * ARCHITECTURE VIOLATION: Using deprecated Horde::img()
 * @deprecated Use Horde_Themes_Image::tag() instead
 * @see Horde_Deprecated::img()
 */
...
$params = ['folks', $user, 'commentCallback', true, null, null,
    ['message_subject' => $user], $conf['comments']['comment_template']];
